...
endpoint = "/policy/api/v1/infra/settings/firewall/security/intrusion-services/signature-versions/DEFAULT/signatures"
result = rest_api_call(method= 'GET', endpoint = endpoint)

#response=requests.get('https://30.30.30.21 + uri',auth=HTTPBasicAuth('admin','VMware1!VMware1!'),verify=False)
